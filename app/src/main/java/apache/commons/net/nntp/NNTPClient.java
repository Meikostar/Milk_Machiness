...
package apache.commons.net.nntp;

import apache.commons.net.MalformedServerReplyException;
import apache.commons.net.io.DotTerminatedMessageReader;
import apache.commons.net.io.DotTerminatedMessageWriter;
 ...
 * {@link apache.commons.net.nntp.NNTP#disconnect  disconnect() }
 * after you're completely finished interacting with the server.
 * Remember that the
 * {@link apache.commons.net.nntp.NNTP#isAllowedToPost isAllowedToPost()}
 *  method is defined in
 * {@link apache.commons.net.nntp.NNTP}.
 * <p>
 ...
 * {@link apache.commons.net.nntp.NNTPReply#SERVICE_DISCONTINUED NNTPReply.SERVICE_DISCONTINUED }
 *  response to a command.
 * When that occurs, the NNTP class method encountering that reply will throw
 * an {@link apache.commons.net.nntp.NNTPConnectionClosedException}
 * .
 ...
 * {@link apache.commons.net.nntp.NNTPConnectionClosedException}
 * , you must disconnect the connection with
 * {@link apache.commons.net.nntp.NNTP#disconnect  disconnect() }
 *  to properly clean up the
 * system resources used by NNTP.  Before disconnecting, you may check the
 * last reply code and text with
 * {@link apache.commons.net.nntp.NNTP#getReplyCode  getReplyCode } and
 * {@link apache.commons.net.nntp.NNTP#getReplyString  getReplyString }.
 * <p>
...
public class NNTPClient extends NNTP
{
     ...
     * {@link apache.commons.net.nntp.SimpleNNTPHeader}
