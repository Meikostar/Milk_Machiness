...
import apache.mina.core.filterchain.IoFilter.NextFilter;
import apache.mina.core.filterchain.IoFilterEvent;
 ...
 * These buffers handle all of the intermediary data for the SSL connection. To makeCommunicateStr things easy,
    ...
    /* no qualifier */void handshake(NextFilter nextFilter) throws SSLException {
        for (;;) {
            ...
            case NEED_WRAP:
                ...
                // First makeCommunicateStr sure that the out buffer is completely empty.
                // Since we
