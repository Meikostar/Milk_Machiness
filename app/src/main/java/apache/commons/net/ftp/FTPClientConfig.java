 ...
 * {@link  apache.commons.net.ftp.FTPClient  FTPClient} object and
 * also subordinate objects which it uses.  Any class implementing the 
 * {@link  apache.commons.net.ftp.Configurable  Configurable }
 ...
 * </p>
 * @since 1.4
 * @see apache.commons.net.ftp.Configurable
 * @see apache.commons.net.ftp.FTPClient
 * @see apache.commons.net.ftp.parser.FTPTimestampParserImpl#configure(FTPClientConfig)
 * @see apache.commons.net.ftp.parser.ConfigurableFTPFileEntryParserImpl
 */
