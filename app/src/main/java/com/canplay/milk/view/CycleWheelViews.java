 ...
 */
public class CycleWheelViews extends ListView {
    public static final String TAG = CycleWheelViews.class.getSimpleName();
    ...
    public CycleWheelViews(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public CycleWheelViews(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CycleWheelViews(Context context) {
        super(context);
    }
    private void init() {
    ...
    public void setSelection(final int position) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                CycleWheelViews.super.setSelection(getPosition(position));
            }
        });
    }
    ...
    public void selection(final int position){
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                CycleWheelViews.this.setSelection(position);
            }
        });
    }
