...
public class PastWipiSearchActivity_ViewBinding implements Unbinder {
  private PastWipiSearchActivity target;

  @UiThread
  public PastWipiSearchActivity_ViewBinding(PastWipiSearchActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PastWipiSearchActivity_ViewBinding(PastWipiSearchActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PastWipiSearchActivity target = this.target;
