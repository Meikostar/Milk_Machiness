...
import apache.mina.transport.socket.DefaultSocketSessionConfig;
import apache.mina.transport.socket.SocketConnector;
...
SocketConnector {
    ...
    protected boolean connect(SocketChannel handle, SocketAddress remoteAddress) throws Exception {
        System.out.println("connect start"+android.os.Process.myPid()+'-'+android.os.Process.myTid());
