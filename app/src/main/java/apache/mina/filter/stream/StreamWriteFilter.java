 ...
 * call {@link IoFilter.NextFilter#messageSent(IoSession, apache.mina.core.write.WriteRequest)} using the original
 * {@link InputStream} written to the session and notifies
 * {@link apache.mina.core.future.WriteFuture} on the
 * original {@link apache.mina.core.write.WriteRequest}.
 * <p/>
 ...
 * has been written. The {@link apache.mina.core.service.IoHandler} should take
 * care of that in its
