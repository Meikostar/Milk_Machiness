...
public class PopView_NavigationBar_Menu_ViewBinding implements Unbinder {
  private PopView_NavigationBar_Menu target;

  @UiThread
  public PopView_NavigationBar_Menu_ViewBinding(PopView_NavigationBar_Menu target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PopView_NavigationBar_Menu target = this.target;
