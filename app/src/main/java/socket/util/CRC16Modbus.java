...
public class CRC16Modbus {
    ...
    public String getCrcHexStr(byte[] data) {
        reset();
        update(data, 0, data.length);
        String crcStr = HexUtil.encodeHexStr(getCrcBytes());
        return crcStr.toUpperCase();
    }

    public String getCrcHexStrReverse(byte[] data) {
        reset();
        update(data, 0, data.length);
        long crc = (int) this.getValue();
        byte[] byteStr = new byte[2];
        ...
        String crcStr = HexUtil.encodeHexStr(byteStr);
        return crcStr.toUpperCase();
    }
