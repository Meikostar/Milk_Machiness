...
public class NavigationBar extends LinearLayout implements View.OnClickListener {
    ...
    public NavigationBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        barStyle.right_imgId = a.getResourceId(R.styleable.NavigationBar_navigationRight_img, R.drawable.arrow_left_whiite);
        ...
        barStyle.left_imgId = a.getResourceId(R.styleable.NavigationBar_navigationLeft_img, R.drawable.arrow_left_whiite);
        barStyle.right_img = a.getResourceId(R.styleable.NavigationBar_right_img, R.drawable.arrow_left_whiite);
