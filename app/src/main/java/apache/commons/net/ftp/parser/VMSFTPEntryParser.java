...
import apache.commons.net.ftp.FTPFile;
import apache.commons.net.ftp.FTPListParseEngine;
 ...
 *
 * @see apache.commons.net.ftp.FTPFileEntryParser FTPFileEntryParser (for usage instructions)
