 ...
 */
package apache.commons.net.ftp;

import apache.commons.net.MalformedServerReplyException;
import apache.commons.net.ftp.parser.DefaultFTPFileEntryParserFactory;
import apache.commons.net.ftp.parser.FTPFileEntryParserFactory;
import apache.commons.net.ftp.parser.ParserInitializationException;
import apache.commons.net.io.CopyStreamEvent;
import apache.commons.net.io.CopyStreamException;
import apache.commons.net.io.FromNetASCIIInputStream;
import apache.commons.net.io.ToNetASCIIOutputStream;
import apache.commons.net.io.Util;
 ...
 * from {@link apache.commons.net.SocketClient},
 * you must first connect to the server with
 * {@link apache.commons.net.SocketClient#connect  connect }
 * before doing anything, and finally
 * {@link apache.commons.net.SocketClient#disconnect  disconnect }
 ...
 * {@link apache.commons.net.ftp.FTP#getReplyCode  getReplyCode } after
 ...
 * {@link apache.commons.net.ftp.FTPReply#SERVICE_NOT_AVAILABLE FTPReply.SERVICE_NOT_AVAILABLE }
 *  response to a command.
 * When that occurs, the FTP class method encountering that reply will throw
 * an {@link apache.commons.net.ftp.FTPConnectionClosedException}
 * .
 ...
 * {@link apache.commons.net.ftp.FTPConnectionClosedException}
 ...
 * {@link apache.commons.net.ftp.FTP#getReplyCode  getReplyCode },
 * {@link apache.commons.net.ftp.FTP#getReplyString  getReplyString },
 * and
 * {@link apache.commons.net.ftp.FTP#getReplyStrings  getReplyStrings}.
 ...
 * can also throw a
 * {@link apache.commons.net.MalformedServerReplyException}
 * , which is a subclass
 ...
 * from apache.commons.net.FTPFileEntryParser:
 * <pre>
 *    FTPClient f = new FTPClient();
 *    f.connect(server);
 *    f.login(username, password);
 ...
 * @see FTPClientConfig
 *
 * @see apache.commons.net.MalformedServerReplyException
 **/
...
implements Configurable
{
    ...
    throws IOException
    {
        ...
        return new apache.commons.net.io.SocketOutputStream(socket, output);
    }
     ...
     *
     * @see apache.commons.net.ftp.parser.FTPFileEntryParserFactory
     * @see apache.commons.net.ftp.parser.DefaultFTPFileEntryParserFactory
     */
    ...
    public InputStream retrieveFileStream(String remote) throws IOException
    {
        ...
        return new apache.commons.net.io.SocketInputStream(socket, input);
    }
     ...
     * @see apache.commons.net.ftp.parser.DefaultFTPFileEntryParserFactory
     * @see apache.commons.net.ftp.parser.FTPFileEntryParserFactory
     * @see apache.commons.net.ftp.FTPFileEntryParser
     */
