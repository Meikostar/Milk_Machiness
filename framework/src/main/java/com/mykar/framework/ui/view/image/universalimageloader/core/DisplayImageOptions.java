 ...
 *******************************************************************************/
package com.mykar.framework.ui.view.image.universalimageloader.core;
...
import com.mykar.framework.ui.view.image.universalimageloader.core.assist.ImageScaleType;
import com.mykar.framework.ui.view.image.universalimageloader.core.display.BitmapDisplayer;
import com.mykar.framework.ui.view.image.universalimageloader.core.process.BitmapProcessor;

/**
 * Contains options for image display. Defines:
 * <ul>
 * <li>whether stub image will be displayed in {@link com.mykar.framework.ui.view.image.universalimageloader.core.imageaware.ImageAware
 ...
 * <li>whether {@link com.mykar.framework.ui.view.image.universalimageloader.core.imageaware.ImageAware image aware view} should be reset
 ...
 * <li>auxiliary object which will be passed to {@link com.mykar.framework.ui.view.image.universalimageloader.core.download.ImageDownloader#getStream(String, Object) ImageDownloader}</li>
...
public final class DisplayImageOptions {
	...
	public Bitmap getBitMapForEmptyUri(Resources res){
		return BitmapFactory.decodeResource(res,imageResForEmptyUri);
	}
	...
	public static class Builder {
		...
		/**
		 * Stub image will be displayed in {@link com.mykar.framework.ui.view.image.universalimageloader.core.imageaware.ImageAware
		...
		/**
		 * Incoming image will be displayed in {@link com.mykar.framework.ui.view.image.universalimageloader.core.imageaware.ImageAware
		 * image aware view} during image loading
		 *
		...
		/**
		 * Incoming drawable will be displayed in {@link com.mykar.framework.ui.view.image.universalimageloader.core.imageaware.ImageAware
		 * image aware view} during image loading.
		...
		/**
		 * {@link com.mykar.framework.ui.view.image.universalimageloader.core.imageaware.ImageAware
		...
		/**
		 * Sets whether {@link com.mykar.framework.ui.view.image.universalimageloader.core.imageaware.ImageAware
		 * image aware view} will be reset (set <b>null</b>) before image loading start
		 */
		...
		/** Sets auxiliary object which will be passed to {@link com.mykar.framework.ui.view.image.universalimageloader.core.download.ImageDownloader#getStream(String, Object)} */
		 ...
		 * {@link com.mykar.framework.ui.view.image.universalimageloader.core.imageaware.ImageAware image aware view} but
		...
		/**
		 * Sets custom {@linkplain Handler handler} for displaying images and firing {@linkplain com.mykar.framework.ui.view.image.universalimageloader.core.listener.ImageLoadingListener
		 * listener} events.
		 */
	 ...
	 * <li>{@link com.mykar.framework.ui.view.image.universalimageloader.core.display.SimpleBitmapDisplayer} will be used for image displaying</li>
	 * </ul>
	 * <p/>
